...
You can manage your **collections** from the Dashboard, with the Web APIs using the [client-side SDKs](/how-to-use) (*superusers only*) or programmatically via the [Go](/go/migrations)/[JavaScript](/js/migrations) migrations.

Similarly, you can manage your **records** from the Dashboard, with the Web APIs using the [client-side SDKs](/how-to-use) or programmatically via the [Go](/go/records)/[JavaScript](/js/records) Record operations.
...
You can find more detailed information in the [Files upload and handling](/files-handling) guide.
