...
::: info
For more details and examples how to interact with Record and Collection models programmatically you could also check [Collection operations](/en/go/collections) and [Record operations](/en/go/records) sections.
:::
