...
1. Create a new environment variable and **set a random 32 characters** string as its value.
   ...
   <span class="txt-hint">e.g. add `export PB_ENCRYPTION_KEY="YshgYqCbKLH5epCUjf2HpJx9Ik3BwwTI"` in your shell profile file</span>

2. Start the application with `--encryptionEnv=YOUR_ENV_VAR` flag.
   
   <span class="txt-hint">e.g. `pocketbase serve --encryptionEnv=PB_ENCRYPTION_KEY`</span>
