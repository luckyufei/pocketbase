...
func TestRecordFieldResolverUpdateQuery(t *testing.T) {
	...
	scenarios := []struct {
		...
		},
		{
			...
			false,
			/* SQLite:
			"SELECT DISTINCT `demo4`.* FROM `demo4` LEFT JOIN json_each(CASE WHEN iif(json_valid([[demo4.self_rel_many]]), json_type([[demo4.self_rel_many]])='array', FALSE) THEN [[demo4.self_rel_many]] ELSE json_array([[demo4.self_rel_many]]) END) `demo4_self_rel_many_je` LEFT JOIN `demo4` `demo4_self_rel_many` ON [[demo4_self_rel_many.id]] = [[__je_demo4_self_rel_many.value]] WHERE [[demo4_self_rel_many.id]] > 1",
			*/
			// PostgreSQL:
		...
		},
		{
			...
			false,
			/* SQLite:
			"SELECT DISTINCT `demo4`.* FROM `demo4` LEFT JOIN json_each(CASE WHEN json_valid([[demo4.self_rel_many]]) THEN [[demo4.self_rel_many]] ELSE json_array([[demo4.self_rel_many]]) END) `demo4_self_rel_many_je` LEFT JOIN `demo4` `demo4_self_rel_many` ON [[demo4_self_rel_many.id]] = [[__je_demo4_self_rel_many.value]] WHERE [[demo4_self_rel_many.self_rel_one]] > 1",
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo4.self_rel_many]] IS JSON OR json_valid([[demo4.self_rel_many]]::text)) AND jsonb_typeof([[demo4.self_rel_many]]::jsonb) = 'array' THEN [[demo4.self_rel_many]]::jsonb ELSE jsonb_build_array([[demo4.self_rel_many]]) END) "__je_demo4_self_rel_many" ON 1=1 LEFT JOIN "demo4" "demo4_self_rel_many" ON [[demo4_self_rel_many.id]] = [[__je_demo4_self_rel_many.value]] WHERE [[demo4_self_rel_many.self_rel_one]] > TRUE`,
		},
		...
		},
		{
			...
			false,
			/* SQLite:
			"SELECT DISTINCT `demo4`.* FROM `demo4` LEFT JOIN json_each(CASE WHEN json_valid([[demo4.self_rel_many]]) THEN [[demo4.self_rel_many]] ELSE json_array([[demo4.self_rel_many]]) END) `demo4_self_rel_many_je` LEFT JOIN `demo4` `demo4_self_rel_many` ON [[demo4_self_rel_many.id]] = [[__je_demo4_self_rel_many.value]] LEFT JOIN `demo4` `demo4_self_rel_many_self_rel_one` ON [[demo4_self_rel_many_self_rel_one.id]] = [[demo4_self_rel_many.self_rel_one]] WHERE [[demo4_self_rel_many_self_rel_one.title]] > 1",
			*/
			// PostgreSQL:
		...
		},
		{
			...
			false,
			/* SQLite:
			"SELECT DISTINCT `demo4`.* FROM `demo4` LEFT JOIN json_each(CASE WHEN json_valid([[demo4.self_rel_many]]) THEN [[demo4.self_rel_many]] ELSE json_array([[demo4.self_rel_many]]) END) `demo4_self_rel_many_je` LEFT JOIN `demo4` `demo4_self_rel_many` ON [[demo4_self_rel_many.id]] = [[__je_demo4_self_rel_many.value]] LEFT JOIN `demo4` `demo4_self_rel_one` ON [[demo4_self_rel_one.id]] = [[demo4.self_rel_one]] WHERE ([[demo4_self_rel_many.title]] = {:TEST} OR (CASE WHEN json_valid([[demo4_self_rel_one.json_object]]) THEN JSON_EXTRACT([[demo4_self_rel_one.json_object]], '$.a') ELSE JSON_EXTRACT(json_object('pb', [[demo4_self_rel_one.json_object]]), '$.pb.a') END) > 1)",
			*/
			// PostgreSQL:
		...
		},
		{
			...
			false,
			/* SQLite:
			"SELECT DISTINCT `demo3`.* FROM `demo3` LEFT JOIN `demo4` `demo3_demo4_via_rel_one_cascade` ON [[demo3.id]] IN (SELECT [[__je_demo3_demo4_via_rel_one_cascade.value]] FROM json_each(CASE WHEN json_valid([[demo3_demo4_via_rel_one_cascade.rel_one_cascade]]) THEN [[demo3_demo4_via_rel_one_cascade.rel_one_cascade]] ELSE json_array([[demo3_demo4_via_rel_one_cascade.rel_one_cascade]]) END) {{__je_demo3_demo4_via_rel_one_cascade}}) WHERE ((([[demo3_demo4_via_rel_one_cascade.id]] = 1) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo3_demo4_via_rel_one_cascade.id]] as [[multiMatchValue]] FROM `demo3` `__mm_demo3` LEFT JOIN `demo4` `__mm_demo3_demo4_via_rel_one_cascade` ON [[__mm_demo3.id]] IN (SELECT [[__je___mm_demo3_demo4_via_rel_one_cascade.value]] FROM json_each(CASE WHEN json_valid([[__mm_demo3_demo4_via_rel_one_cascade.rel_one_cascade]]) THEN [[__mm_demo3_demo4_via_rel_one_cascade.rel_one_cascade]] ELSE json_array([[__mm_demo3_demo4_via_rel_one_cascade.rel_one_cascade]]) END) {{__je___mm_demo3_demo4_via_rel_one_cascade}}) WHERE `__mm_demo3`.`id` = `demo3`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] = 1)))))",
			*/
			// PostgreSQL:
		...
		},
		{
			...
			false,
			/* SQLite:
			"SELECT DISTINCT `demo3`.* FROM `demo3` LEFT JOIN `demo4` `demo3_demo4_via_rel_many_cascade` ON [[demo3.id]] IN (SELECT [[__je_demo3_demo4_via_rel_many_cascade.value]] FROM json_each(CASE WHEN json_valid([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) THEN [[demo3_demo4_via_rel_many_cascade.rel_many_cascade]] ELSE json_array([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) END) {{__je_demo3_demo4_via_rel_many_cascade}}) WHERE [[demo3_demo4_via_rel_many_cascade.id]] = 1",
			*/
			// PostgreSQL:
		...
		},
		{
			...
			false,
			/* SQLite:
			"SELECT DISTINCT `demo3`.* FROM `demo3` LEFT JOIN `demo4` `demo3_demo4_via_rel_many_cascade` ON [[demo3.id]] IN (SELECT [[__je_demo3_demo4_via_rel_many_cascade.value]] FROM json_each(CASE WHEN json_valid([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) THEN [[demo3_demo4_via_rel_many_cascade.rel_many_cascade]] ELSE json_array([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) END) {{__je_demo3_demo4_via_rel_many_cascade}}) WHERE ((([[demo3_demo4_via_rel_many_cascade.id]] = 1) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo3_demo4_via_rel_many_cascade.id]] as [[multiMatchValue]] FROM `demo3` `__mm_demo3` LEFT JOIN `demo4` `__mm_demo3_demo4_via_rel_many_cascade` ON [[__mm_demo3.id]] IN (SELECT [[__je___mm_demo3_demo4_via_rel_many_cascade.value]] FROM json_each(CASE WHEN json_valid([[__mm_demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) THEN [[__mm_demo3_demo4_via_rel_many_cascade.rel_many_cascade]] ELSE json_array([[__mm_demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) END) {{__je___mm_demo3_demo4_via_rel_many_cascade}}) WHERE `__mm_demo3`.`id` = `demo3`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] = 1)))))",
			*/
			// PostgreSQL:
		...
		},
		{
			...
			false,
			/* SQLite:
			"SELECT DISTINCT `demo3`.* FROM `demo3` LEFT JOIN `demo4` `demo3_demo4_via_rel_many_unique` ON [[demo3.id]] IN (SELECT [[__je_demo3_demo4_via_rel_many_unique.value]] FROM json_each(CASE WHEN json_valid([[demo3_demo4_via_rel_many_unique.rel_many_unique]]) THEN [[demo3_demo4_via_rel_many_unique.rel_many_unique]] ELSE json_array([[demo3_demo4_via_rel_many_unique.rel_many_unique]]) END) {{__je_demo3_demo4_via_rel_many_unique}}) WHERE ((([[demo3_demo4_via_rel_many_unique.id]] = 1) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo3_demo4_via_rel_many_unique.id]] as [[multiMatchValue]] FROM `demo3` `__mm_demo3` LEFT JOIN `demo4` `__mm_demo3_demo4_via_rel_many_unique` ON [[__mm_demo3.id]] IN (SELECT [[__je___mm_demo3_demo4_via_rel_many_unique.value]] FROM json_each(CASE WHEN json_valid([[__mm_demo3_demo4_via_rel_many_unique.rel_many_unique]]) THEN [[__mm_demo3_demo4_via_rel_many_unique.rel_many_unique]] ELSE json_array([[__mm_demo3_demo4_via_rel_many_unique.rel_many_unique]]) END) {{__je___mm_demo3_demo4_via_rel_many_unique}}) WHERE `__mm_demo3`.`id` = `demo3`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] = 1)))))",
			*/
			// PostgreSQL:
		...
		},
		{
			...
			false,
			/* SQLite:
			"SELECT DISTINCT `demo3`.* FROM `demo3` LEFT JOIN `demo4` `demo3_demo4_via_rel_many_cascade` ON [[demo3.id]] IN (SELECT [[__je_demo3_demo4_via_rel_many_cascade.value]] FROM json_each(CASE WHEN json_valid([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) THEN [[demo3_demo4_via_rel_many_cascade.rel_many_cascade]] ELSE json_array([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) END) {{__je_demo3_demo4_via_rel_many_cascade}}) LEFT JOIN `demo3` `demo3_demo4_via_rel_many_cascade_rel_one_cascade` ON [[demo3_demo4_via_rel_many_cascade_rel_one_cascade.id]] = [[demo3_demo4_via_rel_many_cascade.rel_one_cascade]] LEFT JOIN `demo4` `demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade` ON [[demo3_demo4_via_rel_many_cascade_rel_one_cascade.id]] IN (SELECT [[__je_demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.value]] FROM json_each(CASE WHEN json_valid([[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.rel_many_cascade]]) THEN [[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.rel_many_cascade]] ELSE json_array([[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.rel_many_cascade]]) END) {{__je_demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade}}) WHERE [[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.id]] = 1",
			*/
			// PostgreSQL:
		...
		},
		{
			...
			false,
			/* SQLite:
			"SELECT DISTINCT `demo1`.* FROM `demo1` LEFT JOIN json_each(CASE WHEN json_valid([[demo1.select_one]]) THEN [[demo1.select_one]] ELSE json_array([[demo1.select_one]]) END) `demo1_select_one_je` LEFT JOIN json_each(CASE WHEN json_valid([[demo1.select_many]]) THEN [[demo1.select_many]] ELSE json_array([[demo1.select_many]]) END) `demo1_select_many_je` LEFT JOIN json_each(CASE WHEN json_valid([[demo1.file_one]]) THEN [[demo1.file_one]] ELSE json_array([[demo1.file_one]]) END) `demo1_file_one_je` LEFT JOIN json_each(CASE WHEN json_valid([[demo1.file_many]]) THEN [[demo1.file_many]] ELSE json_array([[demo1.file_many]]) END) `demo1_file_many_je` LEFT JOIN json_each(CASE WHEN json_valid([[demo1.rel_one]]) THEN [[demo1.rel_one]] ELSE json_array([[demo1.rel_one]]) END) `demo1_rel_one_je` LEFT JOIN json_each(CASE WHEN json_valid([[demo1.rel_many]]) THEN [[demo1.rel_many]] ELSE json_array([[demo1.rel_many]]) END) `demo1_rel_many_je` WHERE ([[__je_demo1_select_one.value]] > 1 AND [[__je_demo1_select_one.value]] < 1 AND (([[__je_demo1_select_many.value]] > 1) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_select_many_je.value]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN json_each(CASE WHEN json_valid([[__mm_demo1.select_many]]) THEN [[__mm_demo1.select_many]] ELSE json_array([[__mm_demo1.select_many]]) END) `__mm_demo1_select_many_je` WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > 1)))) AND [[__je_demo1_select_many.value]] < 1 AND [[__je_demo1_file_one.value]] > 1 AND [[__je_demo1_file_one.value]] < 1 AND (([[__je_demo1_file_many.value]] > 1) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_file_many_je.value]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN json_each(CASE WHEN json_valid([[__mm_demo1.file_many]]) THEN [[__mm_demo1.file_many]] ELSE json_array([[__mm_demo1.file_many]]) END) `__mm_demo1_file_many_je` WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > 1)))) AND [[__je_demo1_file_many.value]] < 1 AND [[__je_demo1_rel_one.value]] > 1 AND [[__je_demo1_rel_one.value]] < 1 AND (([[__je_demo1_rel_many.value]] > 1) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_rel_many_je.value]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN json_each(CASE WHEN json_valid([[__mm_demo1.rel_many]]) THEN [[__mm_demo1.rel_many]] ELSE json_array([[__mm_demo1.rel_many]]) END) `__mm_demo1_rel_many_je` WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > 1)))) AND [[__je_demo1_rel_many.value]] < 1)",
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo1".* FROM "demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo1.select_one]] IS JSON OR json_valid([[demo1.select_one]]::text)) AND jsonb_typeof([[demo1.select_one]]::jsonb) = 'array' THEN [[demo1.select_one]]::jsonb ELSE jsonb_build_array([[demo1.select_one]]) END) "__je_demo1_select_one" ON 1=1 LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo1.select_many]] IS JSON OR json_valid([[demo1.select_many]]::text)) AND jsonb_typeof([[demo1.select_many]]::jsonb) = 'array' THEN [[demo1.select_many]]::jsonb ELSE jsonb_build_array([[demo1.select_many]]) END) "__je_demo1_select_many" ON 1=1 LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo1.file_one]] IS JSON OR json_valid([[demo1.file_one]]::text)) AND jsonb_typeof([[demo1.file_one]]::jsonb) = 'array' THEN [[demo1.file_one]]::jsonb ELSE jsonb_build_array([[demo1.file_one]]) END) "__je_demo1_file_one" ON 1=1 LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo1.file_many]] IS JSON OR json_valid([[demo1.file_many]]::text)) AND jsonb_typeof([[demo1.file_many]]::jsonb) = 'array' THEN [[demo1.file_many]]::jsonb ELSE jsonb_build_array([[demo1.file_many]]) END) "__je_demo1_file_many" ON 1=1 LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo1.rel_one]] IS JSON OR json_valid([[demo1.rel_one]]::text)) AND jsonb_typeof([[demo1.rel_one]]::jsonb) = 'array' THEN [[demo1.rel_one]]::jsonb ELSE jsonb_build_array([[demo1.rel_one]]) END) "__je_demo1_rel_one" ON 1=1 LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo1.rel_many]] IS JSON OR json_valid([[demo1.rel_many]]::text)) AND jsonb_typeof([[demo1.rel_many]]::jsonb) = 'array' THEN [[demo1.rel_many]]::jsonb ELSE jsonb_build_array([[demo1.rel_many]]) END) "__je_demo1_rel_many" ON 1=1 WHERE ([[__je_demo1_select_one.value]] > TRUE AND [[__je_demo1_select_one.value]] < TRUE AND (([[__je_demo1_select_many.value]] > TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_select_many_je.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo1.select_many]] IS JSON OR json_valid([[__mm_demo1.select_many]]::text)) AND jsonb_typeof([[__mm_demo1.select_many]]::jsonb) = 'array' THEN [[__mm_demo1.select_many]]::jsonb ELSE jsonb_build_array([[__mm_demo1.select_many]]) END) "__mm_demo1_select_many_je" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > TRUE)))) AND [[__je_demo1_select_many.value]] < TRUE AND [[__je_demo1_file_one.value]] > TRUE AND [[__je_demo1_file_one.value]] < TRUE AND (([[__je_demo1_file_many.value]] > TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_file_many_je.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo1.file_many]] IS JSON OR json_valid([[__mm_demo1.file_many]]::text)) AND jsonb_typeof([[__mm_demo1.file_many]]::jsonb) = 'array' THEN [[__mm_demo1.file_many]]::jsonb ELSE jsonb_build_array([[__mm_demo1.file_many]]) END) "__mm_demo1_file_many_je" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > TRUE)))) AND [[__je_demo1_file_many.value]] < TRUE AND [[__je_demo1_rel_one.value]] > TRUE AND [[__je_demo1_rel_one.value]] < TRUE AND (([[__je_demo1_rel_many.value]] > TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_rel_many_je.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo1.rel_many]] IS JSON OR json_valid([[__mm_demo1.rel_many]]::text)) AND jsonb_typeof([[__mm_demo1.rel_many]]::jsonb) = 'array' THEN [[__mm_demo1.rel_many]]::jsonb ELSE jsonb_build_array([[__mm_demo1.rel_many]]) END) "__mm_demo1_rel_many_je" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > TRUE)))) AND [[__je_demo1_rel_many.value]] < TRUE)`,
		},
		{
			...
			false,
			/* SQLite:
			"SELECT DISTINCT `demo1`.* FROM `demo1` LEFT JOIN json_each(CASE WHEN json_valid([[demo1.select_one]]) THEN [[demo1.select_one]] ELSE json_array([[demo1.select_one]]) END) `demo1_select_one_je` LEFT JOIN json_each(CASE WHEN json_valid([[demo1.select_many]]) THEN [[demo1.select_many]] ELSE json_array([[demo1.select_many]]) END) `demo1_select_many_je` LEFT JOIN json_each({:dataEachTEST}) `__dataEach_select_many_je` WHERE (((COALESCE([[__je_demo1_select_one.value]], '') IS NOT COALESCE([[__je_demo1_select_many.value]], '')) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_select_many_je.value]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN json_each(CASE WHEN json_valid([[__mm_demo1.select_many]]) THEN [[__mm_demo1.select_many]] ELSE json_array([[__mm_demo1.select_many]]) END) `__mm_demo1_select_many_je` WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__smTEST}} WHERE NOT (COALESCE([[__je_demo1_select_one.value]], '') IS NOT COALESCE([[__smTEST.multiMatchValue]], ''))))) AND (([[__je_demo1_select_many.value]] > [[__je_demo1_select_one.value]]) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_select_many_je.value]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN json_each(CASE WHEN json_valid([[__mm_demo1.select_many]]) THEN [[__mm_demo1.select_many]] ELSE json_array([[__mm_demo1.select_many]]) END) `__mm_demo1_select_many_je` WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > [[__je_demo1_select_one.value]])))) AND [[__je_demo1_select_many.value]] < [[__je_demo1_select_one.value]] AND (([[__je_demo1_select_many.value]] = [[__dataEach_select_many_je.value]]) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_select_many_je.value]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN json_each(CASE WHEN json_valid([[__mm_demo1.select_many]]) THEN [[__mm_demo1.select_many]] ELSE json_array([[__mm_demo1.select_many]]) END) `__mm_demo1_select_many_je` WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__mlTEST}} LEFT JOIN (SELECT [[__mm__dataEach_select_many_je.value]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN json_each({:mmdataEachTEST}) `__mm__dataEach_select_many_je` WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__mrTEST}} WHERE NOT (COALESCE([[__mlTEST.multiMatchValue]], '') = COALESCE([[__mrTEST.multiMatchValue]], ''))))))",
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo1".* FROM "demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo1.select_one]] IS JSON OR json_valid([[demo1.select_one]]::text)) AND jsonb_typeof([[demo1.select_one]]::jsonb) = 'array' THEN [[demo1.select_one]]::jsonb ELSE jsonb_build_array([[demo1.select_one]]) END) "__je_demo1_select_one" ON 1=1 LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo1.select_many]] IS JSON OR json_valid([[demo1.select_many]]::text)) AND jsonb_typeof([[demo1.select_many]]::jsonb) = 'array' THEN [[demo1.select_many]]::jsonb ELSE jsonb_build_array([[demo1.select_many]]) END) "__je_demo1_select_many" ON 1=1 LEFT JOIN jsonb_array_elements({:dataEachTEST}::jsonb) "__dataEach_select_many_je" ON 1=1 WHERE (((to_jsonb([[__je_demo1_select_one.value]]) IS DISTINCT FROM to_jsonb([[__je_demo1_select_many.value]])) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_select_many_je.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo1.select_many]] IS JSON OR json_valid([[__mm_demo1.select_many]]::text)) AND jsonb_typeof([[__mm_demo1.select_many]]::jsonb) = 'array' THEN [[__mm_demo1.select_many]]::jsonb ELSE jsonb_build_array([[__mm_demo1.select_many]]) END) "__mm_demo1_select_many_je" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT (to_jsonb([[__je_demo1_select_one.value]]) IS DISTINCT FROM to_jsonb([[__smTEST.multiMatchValue]]))))) AND (([[__je_demo1_select_many.value]] > [[__je_demo1_select_one.value]]) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_select_many_je.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo1.select_many]] IS JSON OR json_valid([[__mm_demo1.select_many]]::text)) AND jsonb_typeof([[__mm_demo1.select_many]]::jsonb) = 'array' THEN [[__mm_demo1.select_many]]::jsonb ELSE jsonb_build_array([[__mm_demo1.select_many]]) END) "__mm_demo1_select_many_je" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > [[__je_demo1_select_one.value]])))) AND [[__je_demo1_select_many.value]] < [[__je_demo1_select_one.value]] AND (([[__je_demo1_select_many.value]] = [[__dataEach_select_many_je.value]]) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_select_many_je.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo1.select_many]] IS JSON OR json_valid([[__mm_demo1.select_many]]::text)) AND jsonb_typeof([[__mm_demo1.select_many]]::jsonb) = 'array' THEN [[__mm_demo1.select_many]]::jsonb ELSE jsonb_build_array([[__mm_demo1.select_many]]) END) "__mm_demo1_select_many_je" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__mlTEST}} LEFT JOIN (SELECT [[__mm__dataEach_select_many_je.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements({:mmdataEachTEST}::jsonb) "__mm__dataEach_select_many_je" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__mrTEST}} ON 1 = 1 WHERE NOT (to_jsonb([[__mlTEST.multiMatchValue]]) IS NOT DISTINCT FROM to_jsonb([[__mrTEST.multiMatchValue]]))))))`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT "demo1".* FROM "demo1" WHERE (([[demo1.point]]::text = '' OR [[demo1.point]] IS NULL) OR json_query_or_null([[demo1.point]], '$.lat')::jsonb::numeric > 1 OR json_query_or_null([[demo1.point]], '$.lon')::jsonb::numeric < 2 OR json_query_or_null([[demo1.point]], '$.something')::jsonb::numeric > 3)`,
		},
	}
