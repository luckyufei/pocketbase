...
func getTotalViews(app core.App) (int, error) {
	...
	if app.IsPostgres() {
		// PostgreSQL: query information_schema.views
...
func TestSingleVsMultipleValuesNormalization(t *testing.T) {
	...
	tests.DualDBTest(t, func(t *testing.T, app *tests.TestApp, dbType tests.DBType) {
		...
		// PostgreSQL and SQLite have different default value representations
		var tableInfoExpectations map[string]string
