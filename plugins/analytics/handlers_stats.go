// Package analytics 提供分析功能的统计查询 handlers。
package analytics
...
func statsHandler(app core.App) func(*core.RequestEvent) error {
	return func(e *core.RequestEvent) error {
		...
		if err == nil && len(sketches) > 0 {
			_, totalUV, _ = MergeHLLBytes(sketches...)
		} else {
...
// topPagesHandler 处理 Top Pages 查询请求。
// GET /api/analytics/top-pages?range=7d&limit=10
func topPagesHandler(app core.App) func(*core.RequestEvent) error {
	return func(e *core.RequestEvent) error {
		analytics := GetAnalytics(app)
		if analytics == nil || !analytics.IsEnabled() {
			return e.NotFoundError("Analytics is disabled", nil)
...
// topSourcesHandler 处理 Top Sources 查询请求。
// GET /api/analytics/top-sources?range=7d&limit=10
func topSourcesHandler(app core.App) func(*core.RequestEvent) error {
	return func(e *core.RequestEvent) error {
		analytics := GetAnalytics(app)
		if analytics == nil || !analytics.IsEnabled() {
			return e.NotFoundError("Analytics is disabled", nil)
...
// devicesHandler 处理设备分布查询请求。
// GET /api/analytics/devices?range=7d
func devicesHandler(app core.App) func(*core.RequestEvent) error {
	return func(e *core.RequestEvent) error {
		analytics := GetAnalytics(app)
		if analytics == nil || !analytics.IsEnabled() {
			return e.NotFoundError("Analytics is disabled", nil)
...
// rawLogDownloadHandler 下载指定日期的原始日志。
// GET /api/analytics/raw-logs/{date}
func rawLogDownloadHandler(app core.App) func(*core.RequestEvent) error {
	return func(e *core.RequestEvent) error {
		analytics := GetAnalytics(app)
		if analytics == nil || !analytics.IsEnabled() {
			return e.NotFoundError("Analytics is disabled", nil)
...
// configHandler 返回分析配置。
// GET /api/analytics/config
func configHandler(app core.App) func(*core.RequestEvent) error {
	return func(e *core.RequestEvent) error {
		analytics := GetAnalytics(app)
		if analytics == nil {
			return e.JSON(http.StatusOK, map[string]any{
