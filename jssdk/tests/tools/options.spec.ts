...
describe("serializeQueryParams()", function () {
    ...
    test("Should properly serialize different type of parameter values", function () {
        ...
        testParams["@test_array"] = [
            123,
            "@test_arr",
            { "@c": 789 },
            new Date("2025-01-02T01:02:03.456Z"),
            [4, 5, 6],
        ];
